...
const WARNING_BOX_MESSAGE = 'You have no templates. You can create a template when you have at least one cashier account and one difference account. Go back to the $GO_TO_ACCOUNTS page and create the missing accounts. If you need help please checkout our $DOCS_QUICK_START.';
