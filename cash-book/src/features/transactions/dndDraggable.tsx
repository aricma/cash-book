...
const RefTarget = React.forwardRef<HTMLDivElement, RefTargetProps>((
    props,
    ref,
) => {
        ...
        <div ref={elementRef} className="">
            {
                props.isDragging ? (
                    ...
                    <div className="cursor-grab border-2 border-transparent">
                        {props.children}
                    </div>
                )
            }
...
export const Target = DropTarget('transaction', {
