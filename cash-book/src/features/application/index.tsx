        ...
        <div className="w-full h-full p-4 flex items-center justify-center">
            <div className="max-w-lg bg-red-600 shadow-lg shadow-red-500/50 rounded-lg p-4 pt-8 space-y-4">
                ...
                <div className="flex justify-end space-x-2">
                    ...
                    <button type="button" onClick={props.backup.onSelect} className="button button-sm flex items-center space-x-2">
                    ...
                    <button type="button" onClick={props.reload.onSelect} className="button button-sm button-prime flex items-center space-x-2">
