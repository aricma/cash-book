					...
					return (
						<React.Fragment key={index}>
							<div className="flex items-center space-x-2">
								...
								<div className="flex-grow bg-blue-200 dark:bg-blue-900 text-blue-500 dark:text-blue-300 rounded-md shadow-md shadow-blue-600/30 dark:shadow-gray-900 py-2 pl-4 pr-2">
									<div className="flex items-center justify-between space-x-2">
										<div className="">
											<span className="font-bold">
												{transactionViewProps.title}
											</span>
											<div className="text-sm flex items-center space-x-2 dark:text-blue-400">
												<span>{transactionViewProps.cashStation.title}</span>
												<Icon
													type={transactionViewProps.direction}
													className="w-6 h-6"
												/>
			...
			<div className="grid grid-cols-[1fr_max-content_1fr] gap-2">
				...
				<div className="flex items-center justify-center">
					<button
						...
						className="button button-md p-2"
					>
						{props.type.icon && (
				...
				<span className="ml-2 text-sm text-danger">
					{props.cashStation.validation}
				</span>
				<div />
				<span className="ml-2 text-sm text-danger">
					{props.otherAccount.validation}
				</span>
			</div>
		</div>
