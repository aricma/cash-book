...
export const toTemplateConfigProps = (
    ...
    return {
        ...
        diffTransaction: diffValue !== 0 ? {
            ...
            description: 'If you enable this transaction we automatically move the remainder of the aggregated transactions into the difference account',
            input: {
