...
const toTemplateViewProps = (
	...
	transactions: compact(
		Object.values(template.transactions)
	...
	return {
		...
		transactions:
			validationMap?.cashierAccountId === undefined
				? Object.values(appState.transactions.create.transactions)
						.sort((a, b) => a.order - b.order)
						.map((transactionConfig) => toCreateTransactionViewProps(appState, transactionConfig))
				: undefined,
		addTransaction:
			validationMap?.cashierAccountId === undefined
				? {
