...
export const toTemplateConfigProps = (
	...
	const templateConfig =
		req.appState.bookEntries.create.templates[req.appState.bookEntries.create.selectedTemplateId || ''];
...
const validateTransactionValue = (appState: ApplicationState): string | undefined => {
	...
	const value = requiredTransactionIds.reduce((value, transactionId) => {
		...
		const transactionValue = toNumber(templateConfig.transactions[transactionId]) || 0;
