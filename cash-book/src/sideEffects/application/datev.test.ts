...
describe(bookEntryToDatevRows.name, () => {
	...
	test('when called with valid request, returns rows', () => {
		expect(
			...
			['EUR', '+10,00', '', '0101', 'In Acc, In 1', '', '', '1000', '', '', '', '', ''],
			['EUR', '+40,00', '', '0101', 'In Acc, In 2', '', '', '1000', '', '', '', '', ''],
			['EUR', '+50,00', '', '0101', 'In Acc, In 3', '', '', '1000', '', '', '', '', ''],
			['EUR', '+5,00', '', '0101', 'Diff Acc, Diff In', '', '', '2000', '', '', '', '', ''],
			['EUR', '-100,00', '', '0101', 'Out Acc, Out', '', '', '1500', '', '', '', '', ''],
			['EUR', '-5,00', '', '0101', 'Diff Acc, Diff Out', '', '', '2000', '', '', '', '', ''],
		]);
	});
