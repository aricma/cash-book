					...
					>
						<div className="grid grid-cols-[max-content_1fr_max-content] grid-rows-[max-content_max-content] gap-y-2 gap-x-4">
							...
							<div className="flex items-end justify-end">
								<div className="bg-blue-300 dark:bg-blue-800 rounded-md py-1 px-2">{accountProps.number}</div>
							</div>
							<div className="place-self-center">
								<button
									type="button"
									onClick={accountProps.edit.onSelect}
									className="button-prime bg-blue-300 dark:bg-blue-800 button-xs pt-[.35rem] pr-[.35rem]"
								>
							...
							<div className="grid grid-cols-[2fr_1fr_max-content] grid-rows-[max-content_max-content] gap-y-2 gap-x-4">
								...
								<div className="place-self-center">
									<button
										type="button"
										disabled
										className="bg-blue-200 dark:bg-blue-900 text-white dark:text-blue-400 button-xs pt-[.35rem] pr-[.35rem]"
									>
