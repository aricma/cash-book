                    ...
                    <div className="bg-blue-200 dark:bg-blue-900/50 text-blue-500 dark:text-blue-300 rounded-md shadow-md shadow-blue-600/30 dark:shadow-gray-900 py-2 pl-4 pr-2">
                        <div className="grid grid-cols-[max-content_1fr_max-content] grid-rows-[max-content_max-content] gap-y-2 gap-x-4">
                            ...
                            <div className="flex items-end justify-end">
                                <div className="bg-blue-300 dark:bg-blue-800 rounded-md py-1 px-2">
                                    {accountProps.number}
                                </div>
                            </div>
                            <div className="place-self-center">
                                <button type="button" onClick={accountProps.edit.onSelect} className="button-prime bg-blue-300 dark:bg-blue-800 button-xs pt-[.35rem] pr-[.35rem]">
...
export const AccountsSkeleton: React.FC = () => (
    <>
        {Array(3).fill(null).map((_, index) => {
            return (
                <React.Fragment key={index}>
                    <div className="bg-blue-100 dark:bg-blue-900/50 rounded-md py-2 pl-4 pr-2">
                        <div className="grid grid-cols-[2fr_1fr_max-content] grid-rows-[max-content_max-content] gap-y-2 gap-x-4">
                            <div className="min-w-[3rem] bg-blue-200 dark:bg-blue-900 rounded-md" />
                            <div className="min-w-[3rem] bg-blue-200 dark:bg-blue-900 rounded-md" />
                            <div className="place-self-center">
                                <button type="button" disabled className="bg-blue-200 dark:bg-blue-900 text-white dark:text-blue-400 button-xs pt-[.35rem] pr-[.35rem]">
