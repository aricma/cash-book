...
export const toTransactionsViewProps = (
	...
	transactions: {
		...
		transactions: compact(
			Object.values(appState.transactions.transactions)
...
export const toCreateTransactionViewProps = (
	...
	return {
		...
		type: {
			type: 'BUTTON_PROPS_TYPE',
			icon:
				appState.transactions.create.type === TransactionType.OUT
					? IconType.ARROW_NARROW_RIGHT_STROKE
					: IconType.ARROW_NARROW_LEFT_STROKE,
		...
		otherAccount: {
			...
			value:
				appState.accounts.accounts[
					appState.transactions.create.otherAccountId || ''
				]?.name || '',
...
const validateCreateTransaction = (
	...
	const cashierAccountId = !!appState.transactions.create.cashierAccountId
		? undefined
		: 'Cashier is missing!';
	const otherAccountId = !!appState.transactions.create.otherAccountId
		? undefined
