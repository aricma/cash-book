...
export const toNumber = (value: string): number | undefined => Number.isNaN(Number(value)) ? undefined : Number(value);

export type PrecedenceTable<A, B> = Array<[A, B, -1 | 0 | 1]>;
export const isPrecedent = <A, B>(table: PrecedenceTable<A, B>) => (a: A, b: B): number => {
