...
export const toMenuViewProps = (
	...
	switch (true) {
		case hasNoAccount:
			return {
				pages: [accountsButton, settingsButton, supportButton],
			};
		case hasNoTransactions:
			return {
				pages: [accountsButton, transactionsButton, settingsButton, supportButton],
			};
		case hasNoEntries:
			return {
				pages: [accountsButton, transactionsButton, createBookEntry, settingsButton, supportButton],
			};
		default:
			return {
				pages: [accountsButton, transactionsButton, createBookEntry, entriesButton, settingsButton],
			};
	}
};
