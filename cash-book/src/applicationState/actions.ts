...
export enum ApplicationActionType {
    ...
    TRANSACTIONS_CREATE_SET_CASH_STATION = 'APPLICATION_ACTION_TYPE/TRANSACTIONS/CREATE/CASH_STATION/SET',
...
export type AccountsCreateSetType = Action<ApplicationActionType.ACCOUNTS_CREATE_SET_TYPE,
    { value: AccountType }>;
export type AccountsCreateSetName = Action<ApplicationActionType.ACCOUNTS_CREATE_SET_NAME,
    { value: string }>;
export type AccountsCreteSetNumber = Action<ApplicationActionType.ACCOUNTS_CREATE_SET_NUMBER,
    { value: string }>;
...
export type TransactionsOrderInc = Action<ApplicationActionType.TRANSACTIONS_ORDER_INC, { transactionId: string }>;
export type TransactionsOrderDec = Action<ApplicationActionType.TRANSACTIONS_ORDER_DEC, { transactionId: string }>;
export type TransactionsCreateSetType = Action<ApplicationActionType.TRANSACTIONS_CREATE_SET_TYPE,
    { value: TransactionType }>;
export type TransactionsCreateSetName = Action<ApplicationActionType.TRANSACTIONS_CREATE_SET_NAME,
    { value: string }>;
export type TransactionsCreateSetCashStation = Action<ApplicationActionType.TRANSACTIONS_CREATE_SET_CASH_STATION,
    { value: string }>;
export type TransactionsCreateSetOtherAccount = Action<ApplicationActionType.TRANSACTIONS_CREATE_SET_OTHER_ACCOUNT,
    { value: string }>;
...
export type BookEntriesExportDay = Action<ApplicationActionType.BOOK_ENTRIES_EXPORT_DAY, {
    date: string;
}>;
export type BookEntriesExportMonth = Action<ApplicationActionType.BOOK_ENTRIES_EXPORT_MONTH, {
    date: string;
}>;
export type BookEntriesCreateSetDate = Action<ApplicationActionType.BOOK_ENTRIES_CREATE_SET_DATE, { date: string }>;
...
export type BookEntriesCreateCancel = Action<ApplicationActionType.BOOK_ENTRIES_CREATE_CANCEL>;
export type BookEntriesCreateSubmit = Action<ApplicationActionType.BOOK_ENTRIES_CREATE_SUBMIT>;
