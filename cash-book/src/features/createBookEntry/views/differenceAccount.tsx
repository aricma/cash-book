...
export const DifferenceAccount: React.FC<ToggleDiffViewProps> = (props) => {
	switch (props.type) {
		case ToggleDiffViewType.DEFAULT:
			return (
				<div className="bg-blue-100 dark:bg-blue-900 p-4 rounded-xl flex items-center justify-between space-x-4 text-blue-600 dark:text-blue-400">
		...
		case ToggleDiffViewType.WARNING:
			return (
				<div className="bg-yellow-100 dark:bg-yellow-900 p-4 rounded-xl flex items-center justify-between space-x-4 text-yellow-600 dark:text-yellow-400">
					<input type="checkbox" checked={props.input.value} onChange={props.input.onChange} className="shrink-0" />
					<div className="space-y-4">
		...
		case ToggleDiffViewType.DANGER:
			return (
				<div className="bg-red-100 dark:bg-red-900 p-4 rounded-xl flex items-center justify-between space-x-4 text-red-600 dark:text-red-400">
					<input type="checkbox" checked={props.input.value} onChange={props.input.onChange} className="shrink-0" />
					<div className="space-y-4">
