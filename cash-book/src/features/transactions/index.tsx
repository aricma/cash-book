...
import {toCreateTransactionViewProps, toTransactionsViewProps} from './toProps';
...
export const Transactions: React.FC = () => {
    ...
    const createTransactionViewProps = toCreateTransactionViewProps(appState, () => setShowCreateView(false));
    return (
        <>
