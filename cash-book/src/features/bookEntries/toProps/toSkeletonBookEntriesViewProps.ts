...
const INFOBOX_MESSAGE =
	'You have currently no book entries. $CREATE a book entry for this template. If you do not know how to create a book entry then visit our $DOCS_CREATE_BOOK_ENTRY.';
